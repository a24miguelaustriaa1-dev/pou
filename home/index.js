...
let homeSong = new Audio("crazy train.mp3");
...
function homeSongPlay() {
    ...
    if (homeSong.paused) {
        ...
        masterSongTitle.textContent = "Crazy Train ";
        masterSongInfo.textContent = "Ozzy Osbourne";
        masterCover.src = "wizard of oz.jpg";
...
uploadInput.addEventListener("change", (event) => {
  ...
  masterSongTitle.textContent = file.name;
  masterSongInfo.textContent = "Local file";
  masterCover.src = "https://cdn-icons-png.flaticon.com/512/727/727245.png"; // ícono genérico
  masterPlayBtn.classList.remove("fa-circle-play");
  masterPlayBtn.classList.add("fa-circle-pause");
});
